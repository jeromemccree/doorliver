...
//         },
//         fontawesome4: {
//             base: path.src.scss + 'vendor/fontawesome4/',
//             src: 'node_modules/font-awesome/scss/**/*',
//             dest: path.src.scss + 'vendor/fontawesome4/'
//         },
//         fontawesome5: {
//             base: path.src.scss + 'vendor/fontawesome5/',
//             src: 'node_modules/@fortawesome/fontawesome-free/scss/**/*',
//             dest: path.src.scss + 'vendor/fontawesome5/'
//         }
//     },
//     fonts: {
//         fontawesome4: {
//             base: path.src.fonts + 'fontawesome4/',
//             src: 'node_modules/font-awesome/fonts/**/*',
//             dest: path.src.fonts + 'fontawesome4/'
//         },
//         fontawesome5: {
//             base: path.src.fonts + 'fontawesome5/',
//             src: 'node_modules/@fortawesome/fontawesome-free/webfonts/**/*',
//             dest: path.src.fonts + 'fontawesome5/'
//         }
//     },
//     js: {
//         core: {
...
//             },
//             'jquery-countto': {
//                 base: path.src.jscore + 'jquery.countTo.min.js',
//                 src: 'node_modules/jquery-countto/jquery.countTo.js',
//                 dest: path.src.jscore,
//                 min: true
//             },
//             'js-cookie': {
...
//             },
//             'chart.js': {
//                 base: path.src.jsplugins + 'chartjs/',
//                 src: ['node_modules/chart.js/dist/**/*.*', '!node_modules/chart.js/dist/docs/**/*.*'],
//                 dest: path.src.jsplugins + 'chartjs/'
//             },
//             ckeditor: {
...
//             },
//             dropzone: {
//                 base: path.src.jsplugins + 'dropzonejs/dist',
//                 src: 'node_modules/dropzone/dist/**/*.*',
//                 dest: path.src.jsplugins + 'dropzonejs/dist'
//             },
//             'easy-pie-chart': {
...
//             },
//             gmaps: {
//                 base: path.src.jsplugins + 'gmapsjs/',
//                 src: 'node_modules/gmaps/gmaps*.*',
//                 dest: path.src.jsplugins + 'gmapsjs/'
//             },
//             'jquery-slimscroll': {
//                 base: path.src.jsplugins + 'jquery-slimscroll/',
//                 src: 'node_modules/jquery-slimscroll/jquery.slimscroll*.*',
//                 dest: path.src.jsplugins + 'jquery-slimscroll/'
//             },
//             'jquery-countdown': {
...
//             },
//             jvectormap: {
//                 base: path.src.jsplugins + 'jquery-jvectormap/dist/',
//                 src: 'node_modules/jvectormap-next/jquery-jvectormap*.*',
//                 dest: path.src.jsplugins + 'jquery-jvectormap/dist/'
//             },
//             'raty-js': {
//                 base: path.src.jsplugins + 'jquery-raty/',
//                 src: 'node_modules/raty-js/lib/**/*.*',
//                 dest: path.src.jsplugins + 'jquery-raty/'
//             },
//             'jquery-validation': {
...
//             },
//             'slick-carousel': {
//                 base: path.src.jsplugins + 'slick/',
//                 src: 'node_modules/slick-carousel/slick/**/*.*',
//                 dest: path.src.jsplugins + 'slick/'
//             },
//             'jquery-sparkline': {
//                 base: path.src.jsplugins + 'sparkline/',
//                 src: 'node_modules/jquery-sparkline/jquery*.js',
//                 dest: path.src.jsplugins + 'sparkline/'
//             },
//             sweetalert2: {
...
//                 base: path.src.jsplugins + 'bootstrap-wizard/bs3',
//                 src: 'node_modules/jquery-bootstrap-wizard/jquery*.js',
//                 dest: path.src.jsplugins + 'bootstrap-wizard/bs3'
//             },
//             datatables: {
